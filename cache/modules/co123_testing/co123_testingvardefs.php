<?php 
 $GLOBALS["dictionary"]["co123_testing"]=array (
  'table' => 'co123_testing',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'co123_testing_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'co123_testing_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'co123_testing_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_co123_testing',
    ...
    'co123_testing_type' => 
    array (
      'name' => 'co123_testing_type',
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'co123_testing_type_dom',
      'len' => 100,
